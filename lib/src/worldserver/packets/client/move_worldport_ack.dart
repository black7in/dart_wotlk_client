...
/// CMSG_MOVE_WORLDPORT_ACK packet
///
/// Sent by client to acknowledge world port/login
/// This tells the server we're ready to receive world data
class MoveWorldportAckPacket {
  ...
  Uint8List buildClientPacket() {
    ...
    packet.setUint32(2, ClientOpcode.MSG_MOVE_WORLDPORT_ACK.value, Endian.little);
